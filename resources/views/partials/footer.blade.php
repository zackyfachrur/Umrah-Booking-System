<div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
    <div class="lg:flex lg:items-start lg:gap-8">
        <div class="text-teal-600">
            <img src="/assets/images/Logo/Brand-Logo.png" alt="Logo Al Misbah" class="w-80">
        </div>
            ...
            <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                <form class="w-full">
                    ...
                    <div
                        ...
                        <button
                            class="mt-1 w-full bg-gradient-to-r from-[var(--color-secondary)] to-[var(--color-secondary-dark)] px-6 py-3 text-sm font-bold tracking-wide text-white uppercase transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0">
                            Sign Up
                        </button>
                    </div>
                </form>
